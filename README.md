...
Releases previous to 2.8.14 are still available under the [2-Clause BSD License](https://opensource.org/licenses/BSD-2-Clause) [here](https://github.com/net-lisias-kspu/SmokeScreen/tree/Source/BSD-2Clause) (and on the previous maintainer's repository, see below). Please note this [statement](https://www.gnu.org/licenses/license-list.en.html#FreeBSD) from FSF.
